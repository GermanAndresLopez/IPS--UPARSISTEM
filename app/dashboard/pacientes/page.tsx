    ...
    <div className="p-6 space-y-5 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{PACIENTES_MOCK.length} pacientes registrados</p>
        </div>
        {rol !== "OPERATIVO" && (
          <Link
